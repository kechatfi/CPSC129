...
#
# Version 1 (archived as object_server_1.py)
#
# - Removed dependencies on quote and Quote and generalized to work
#   with any object type. Tested with hockey_player.py as well
#   as quote.
#
    ...
    def do_GET(self):
        ...
        if self.path == '/':
            ...
            title_block = '''
                ...
                <form method="GET" action="/object_creation_menu"> 
