...
def is_goal(state, goal):
    ...
    for subset_num in range(1, 2**len(state)):
...
def solve_it(pitchers, goal):
    ...
    '''
    state_list = [pitchers] # See note 0 # Initialize the state list
...
if __name__ == '__main__':
    ...
    goal = 1
    start = [Pitcher(2,0), Pitcher(5,0), Pitcher(10,0)]
    solve_it(start, goal)
    
    # Test Problem 3: Measure 2 litres using 3 and 7 litre pitchers
    goal = 2
    start = [Pitcher(3,0), Pitcher(7,0)]
    solve_it(start, goal)
    
    # Test Problem 4: Impossible problem
    # Measure 1 litres using 5 and 10 litre pitchers
    goal = 1
    start = [Pitcher(5,0), Pitcher(10,0)]
    solve_it(start, goal)
    
    # Test Problem 5: Multi-pitcher solution
    # Measure 10 litres using 3 and 7 litre pitchers
    goal = 10
    start = [Pitcher(3,0), Pitcher(7,0)]
    solve_it(start, goal)
                
    # Test Problem 6: Multi-pitcher solution
    # Measure 12 litres using 2, 5 and 10 litre pitchers
    goal = 12
    start = [Pitcher(2,0), Pitcher(5,0), Pitcher(10,0)]
    solve_it(start, goal)
