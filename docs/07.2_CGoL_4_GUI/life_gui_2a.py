...
for y in range(0, U_ROWS+1):
    pygame.draw.line(screen, GREY, (SCREEN_BORDER, SCREEN_BORDER + MENU_HEIGHT + y*grid_size),
                     (SCREEN_WIDTH - SCREEN_BORDER - 1, SCREEN_BORDER + MENU_HEIGHT + y*grid_size))

# Draw vertical lines.
for x in range(0, U_COLS+1):
    pygame.draw.line(screen, GREY, (SCREEN_BORDER + x*grid_size, SCREEN_BORDER + MENU_HEIGHT),
